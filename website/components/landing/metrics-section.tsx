...
const metrics = [
  {
    ...
    suffix: "ms",
    prefix: "<",
    label: "Retrieval P95 target · local profile",
  },
  {
    value: 6,
    suffix: "",
  ...
  },
  {
    ...
    suffix: "",
    prefix: "",
    label: "Chunking strategies to compare",
  },
  {
    value: 2,
    suffix: "",
    prefix: "",
    label: "Provider profiles · local / cloud",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16 lg:mb-24">
          ...
          <div className="flex items-center gap-4 font-mono text-sm text-muted-foreground">
            ...
            <span className="min-w-[7ch] tabular-nums">{time ?? "-"}</span>
          </div>
        </div>
