...
const features = [
  ...
  {
    number: "04",
    title: "Guardrails before generate",
    description:
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Query to Context
            <br />
            <span className="text-muted-foreground">retrieved - not invented.</span>
          </h2>
        </div>
